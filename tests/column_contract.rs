...
const FAMILIES: &[&str] = &[
    ...
    "scheduler_action,scheduler_reason,trigger_reason,scheduler_not_before_utc,provider_accounting_date,provider_daily_starts,bandwidth_start_reserved",
...
fn csv_and_json_use_the_same_complete_family_order() {
    ...
    assert_eq!(expected.split(',').count(), 67);
