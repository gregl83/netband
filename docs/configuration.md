...
| `--bandwidth-timeout DURATION` | `bandwidth.whole_test_timeout` | `55s` for discovery, download, upload, and cleanup together; completed downloads and valid upload reports survive timeout |
